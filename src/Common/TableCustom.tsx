...
interface TableCustomProps {
  ...
  setPaginationData?: (prevState: any) => any;
  tableclassName?: any;
  divclassName?: any;
  thclassName?: any;
  trclassName?: any;
...
const TableCustom = ({
  ...
  const lastPage = () => {
    if (getCanNextPage() && setPaginationData && pageCount) {
  ...
  const firstPage = () => {
    if (getCanPreviousPage() && setPaginationData) {
      const state = getState().pagination;
      setPaginationData({
        ...state,
        pageIndex: 0,
      ...
      {isPagination && (
        <div className={PaginationClassName}>
          ...
          <ul className="flex flex-wrap items-center gap-2 shrink-0">
            ...
            {/*       onClick={() => { */}
            {/*         if(!setPaginationData) return; */}
            {/*         setPaginationData((prev: any) => ({ ...prev, pageIndex: item })) */}
            {/*       }} */}
            {/*       >{item + 1}</Link> */}
            {/*     </li> */}
            {/*   </React.Fragment> */}
